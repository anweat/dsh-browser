export const zh = {
  ...
  assetLibrary: '可复用自动化资产', assetLibraryHint: '候选先提示是否总结；草稿测试后再手动激活。源码仅在点选编辑时读取。',
  ...
  assetEditor: '资产编辑器（JSON）', assetEditorHint: '选择资产或新建草稿。', assetInvalid: 'JSON 或资产字段无效。', assetSourceBoundary: '不要保存 cookie、token、密码、完整页面内容或聊天记录。', assetTest: '测试', assetActivate: '激活', assetArchive: '归档', assetSaveDraft: '保存草稿',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  assetLibrary: 'Reusable automation assets', assetLibraryHint: 'Candidates ask before summarization; drafts are tested before manual activation. Source loads only when selected.',
  ...
  assetEditor: 'Asset editor (JSON)', assetEditorHint: 'Select an asset or create a draft.', assetInvalid: 'Invalid JSON or asset fields.', assetSourceBoundary: 'Do not store cookies, tokens, passwords, full page content, or conversation transcripts.', assetTest: 'Test', assetActivate: 'Activate', assetArchive: 'Archive', assetSaveDraft: 'Save draft',
