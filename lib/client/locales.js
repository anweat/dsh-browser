export const zh = {
    ...
    cdpPort: 'CDP 调试端口', cdpPortHint: '可选的本机远程调试端口（1–65535）；留空即关闭。',
    args: 'Chromium 启动参数 JSON', argsHint: '可选字符串数组；仅添加你信任并理解其影响的参数。',
    ...
    reset: '恢复部署值', overridden: '已覆盖', invalidNumber: '请填写数字，留空表示使用默认值。', unavailable: '该插件当前未加载，暂时无法配置。',
    invalid: '值无效，请检查格式或范围。', invalidJson: 'JSON 或数值范围无效。',
...
export const en = {
    ...
    cdpPort: 'CDP debugging port', cdpPortHint: 'Optional local remote-debugging port (1–65535); leave empty to disable.',
    args: 'Chromium launch arguments JSON', argsHint: 'Optional string array; add only arguments whose effects you understand and trust.',
    ...
    reset: 'Restore deployed', overridden: 'Overridden', invalidNumber: 'Enter a number, or leave blank to use the default.', unavailable: 'This plugin is not loaded, so it cannot be configured right now.',
    invalid: 'Invalid value. Check format and bounds.', invalidJson: 'Invalid JSON or numeric bounds.',
