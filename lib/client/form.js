...
function validAssetPolicy(value) {
    ...
    return Object.entries(value).every(([key, entry]) => {
        if (!['minSuccessfulRuns', 'minDistinctSessions', 'successWindowDays', 'minSuccessRate', 'maxCandidates', 'candidateTtlDays', 'maxSuggestionsPerDay', 'maxDrafts', 'maxActiveAssets', 'retrievalTopK', 'catalogTokenBudget'].includes(key))
            return true;
